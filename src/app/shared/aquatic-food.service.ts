...
export class AquaticFoodService {
  ...
  addAquaticFood(name: string, onHand: number, url: string, detail: string, menu: Array<string>) {
    this.aquaticFoods.push(new AquaticFood(name, detail, url, onHand, 0, menu));
  }
